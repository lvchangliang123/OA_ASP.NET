        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WeChatCount = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                    QQCount = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                    WeiboCount = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true),
                    GithubCount = table.Column<string>(type: "varchar(255)", maxLength: 255, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AutherInfo", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AutherInfo_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comment_BlogId",
                        column: x => x.BlogId,
                        principalSchema: "VueNetBlogDB_Test",
                        principalTable: "Blog",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
